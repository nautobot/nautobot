"""Signal receivers for netbox.users."""
import logging
...
from netbox.authentication import assign_groups_to_user, assign_permissions_to_user
from users.models import AdminUser

logger = logging.getLogger("netbox.users.signals")
