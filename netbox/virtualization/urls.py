...
urlpatterns = [
    ...
    path('cluster-types/<slug:slug>/', views.ClusterTypeView.as_view(), name='clustertype'),
    ...
    path('cluster-groups/<slug:slug>/', views.ClusterGroupView.as_view(), name='clustergroup'),
