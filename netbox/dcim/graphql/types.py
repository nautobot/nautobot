...
from dcim.models import Site, Device, Interface, Rack, Cable, ConsoleServerPort
...
class CableTerminationMixin:
    ...
    connected_interface = graphene.Field("dcim.graphql.types.InterfaceType")
    connected_circuit_termination = graphene.Field("circuits.graphql.types.CircuitTerminationType")
    connected_console_server_port = graphene.Field("dcim.graphql.types.ConsoleServerPortType")
