    ...
    def save(self, *args, trigger_resync=True, **kwargs):
        ...
        def on_commit_callback():
            if self.__initial_slug and self.slug != self.__initial_slug:
                ...
                # TODO: In a distributed NetBox deployment, each Django instance and/or RQ worker instance may
            ...
            if trigger_resync:
                ...
                from extras.datasources import enqueue_pull_git_repository_and_refresh_data
