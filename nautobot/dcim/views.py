...
from nautobot.dcim.utils import get_network_driver_mapping_tool_names, get_network_driver_mappings
...
class PlatformEditView(generic.ObjectEditView):
    ...
    def get_extra_context(self, request, instance):
        return {"network_driver_names": sorted(get_network_driver_mappings().keys())}
