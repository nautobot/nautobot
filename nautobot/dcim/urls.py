...
urlpatterns = [
    ...
    path(
        "devices-types/<uuid:pk>/console-server-ports/add/",
        RedirectView.as_view(
    ...
    path(
        "device-types/<uuid:pk>/power-ports-template/add/",
        RedirectView.as_view(
    ...
    path(
        "device-types/<uuid:pk>/power-outlets-template/add/",
        RedirectView.as_view(
    ...
    path(
        "device-types/<uuid:pk>/interfaces-template/add/",
        RedirectView.as_view(
    ...
    path(
        "device-types/<uuid:pk>/front-ports-template/add/",
        RedirectView.as_view(
    ...
    path(
        "device-types/<uuid:pk>/rear-ports-template/add/",
        RedirectView.as_view(
    ...
    path(
        "device-types/<uuid:pk>/device-bays-template/add/",
        RedirectView.as_view(
    ...
    path(
        "device-types/<uuid:pk>/module-bays-template/add/",
        RedirectView.as_view(
