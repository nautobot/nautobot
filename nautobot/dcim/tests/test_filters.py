...
class PowerFeedTestCase(PathEndpointModelTestMixin, FilterTestCases.FilterTestCase):
    ...
    def setUpTestData(cls):
        ...
        PowerFeed.objects.filter(pk=power_feeds[0].pk).update(
            ...
            max_utilization=10,
            comments="PFA",
            power_path=PowerFeedPowerPathChoices.SIDE_A,
            breaker_position=1,
        ...
        PowerFeed.objects.filter(pk=power_feeds[1].pk).update(
            ...
            max_utilization=20,
            comments="PFB",
            power_path=PowerFeedPowerPathChoices.SIDE_B,
            breaker_position=4,
    ...
    def test_power_path(self):
        params = {"power_path": [PowerFeedPowerPathChoices.SIDE_A]}
        self.assertQuerysetEqualAndNotEmpty(
            self.filterset(params, self.queryset).qs,
            self.queryset.filter(power_path=PowerFeedPowerPathChoices.SIDE_A),
        )
