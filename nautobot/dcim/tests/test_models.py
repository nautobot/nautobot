...
class FrontPortTestCase(ModelTestCases.BaseModelTestCase):
    ...
    def test_uniqueness(self):
        """Assert that the combination of device, module, and name is unique."""
...
class ModuleBayTestCase(ModularDeviceComponentTestCaseMixin, ModelTestCases.BaseModelTestCase):
    ...
    def test_parent_property(self):
        ...
        for o in (grandchild_module_bay, parent_module_bay, child_module_bay):
            o.refresh_from_db()
...
class ModuleTestCase(ModelTestCases.BaseModelTestCase):
    ...
    def test_device_property(self):
        ...
        for o in (grandchild_module, parent_module, child_module):
            o.refresh_from_db()
