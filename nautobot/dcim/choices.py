...
class InterfaceTypeChoices(ChoiceSet):
    ...
    CHOICES = (
        ...
        (
            "InfiniBand",
            (
                (TYPE_INFINIBAND_SDR, "SDR (8 Gbps)"),
                (TYPE_INFINIBAND_DDR, "DDR (16 Gbps)"),
                (TYPE_INFINIBAND_QDR, "QDR (32 Gbps)"),
                (TYPE_INFINIBAND_FDR10, "FDR10 (40 Gbps)"),
                (TYPE_INFINIBAND_FDR, "FDR (56 Gbps)"),
                (TYPE_INFINIBAND_EDR, "EDR (100 Gbps)"),
                (TYPE_INFINIBAND_HDR, "HDR (200 Gbps)"),
                (TYPE_INFINIBAND_NDR, "NDR (400 Gbps)"),
                (TYPE_INFINIBAND_XDR, "XDR (800 Gbps)"),  
            ),
        ),
        (
            "Serial",
