# Generated by Django 4.2.23 on 2025-08-11 17:27
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='power_factor',
            field=models.DecimalField(decimal_places=2, default='0.95', max_digits=4, validators=[django.core.validators.MinValueValidator(0.01), django.core.validators.MaxValueValidator(1.0)]),
        ),
        migrations.AddField(
        ...
        migrations.AlterUniqueTogether(
            name='powerfeed',
            unique_together={('power_panel', 'name'), ('power_panel', 'breaker_position')},
        ),
        migrations.AddIndex(
            model_name='powerfeed',
