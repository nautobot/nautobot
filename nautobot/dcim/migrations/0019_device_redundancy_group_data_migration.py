...
def populate_device_redundancy_group_status(apps, schema_editor):
    ...
    populate_metadata_choices(apps, schema_editor, models=["dcim.DeviceRedundancyGroup"])
...
def clear_device_redundancy_group_status(apps, schema_editor):
    ...
    clear_metadata_choices(apps, schema_editor, models=["dcim.DeviceRedundancyGroup"])
