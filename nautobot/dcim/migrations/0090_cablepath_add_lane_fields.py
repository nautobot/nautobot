...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name="cablepath", name="peer_connector", field=models.PositiveSmallIntegerField(blank=True, null=True)
        ),
            ...
            options={
                "ordering": [
                    django.db.models.expressions.OrderBy(
                        django.db.models.expressions.F("peer_connector"), nulls_first=True
                    ),
                ]
            },
        ),
