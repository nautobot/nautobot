    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_name', nautobot.utilities.fields.NaturalOrderingField('name', blank=True, max_length=100, naturalize_function=nautobot.utilities.ordering.naturalize)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_updated', models.DateTimeField(auto_now=True, null=True)),
                ('custom_field_data', models.JSONField(blank=True, default=dict, encoder=django.core.serializers.json.DjangoJSONEncoder)),
                ('local_context_data', models.JSONField(blank=True, null=True, encoder=django.core.serializers.json.DjangoJSONEncoder)),
                ('local_context_data_owner_object_id', models.UUIDField(blank=True, default=None, null=True)),
                ('name', models.CharField(blank=True, max_length=64, null=True)),
                ('_name', nautobot.utilities.fields.NaturalOrderingField('name', blank=True, max_length=100, naturalize_function=nautobot.utilities.ordering.naturalize, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_name', nautobot.utilities.fields.NaturalOrderingField('name', blank=True, max_length=100, naturalize_function=nautobot.utilities.ordering.naturalize_interface)),
                ('type', models.CharField(max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('napalm_args', models.JSONField(blank=True, null=True, encoder=django.core.serializers.json.DjangoJSONEncoder)),
                ('description', models.CharField(blank=True, max_length=200)),
            ],
            options={
                'ordering': ['name'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('voltage', models.SmallIntegerField(default=120, validators=[nautobot.utilities.validators.ExclusionValidator([0])])),
