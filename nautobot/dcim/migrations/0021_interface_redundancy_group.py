# Generated by Django 3.2.19 on 2023-07-27 02:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dcim.interfaceredundancygroup')),
        ...
        migrations.AddField(
            ...
            name='interfaces',
            field=models.ManyToManyField(blank=True, related_name='redundancy_groups', through='dcim.InterfaceRedundancyGroupAssociation', to='dcim.Interface'),
        ),
        migrations.AddField(
            model_name='interfaceredundancygroup',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='extras.configcontextschema'),
        ),
        migrations.AddField(
            model_name='interfaceredundancygroup',
            name='secrets_group',
        ...
        migrations.AddField(
            model_name='interfaceredundancygroup',
            name='status',
            field=nautobot.extras.models.statuses.StatusField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='dcim_interfaceredundancygroup_related', to='extras.status'),
        ),
        migrations.AddField(
            model_name='interfaceredundancygroup',
            name='tags',
        ...
        migrations.AddField(
            model_name='interfaceredundancygroup',
            name='virtual_ip',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='interface_redundancy_virtual_ip', to='ipam.ipaddress'),
        ),
    ]
