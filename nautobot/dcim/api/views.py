...
class SiteViewSet(NautobotModelViewSet):
    ...
    # TODO: I believe this is part of the "autogenerated edit forms" proof-of-concept.
    # This pattern needs to be documented if we're going to move forward with it.
    # TODO: shouldn't this be "get_field_groups" not "get_field_group"?
