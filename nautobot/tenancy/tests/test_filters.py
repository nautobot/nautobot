...
class TenantGroupTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        TenantGroup.objects.create(name='Tenant Group 1', slug='tenant-group-1', parent=parent_tenant_groups[0], description='A'),
        TenantGroup.objects.create(name='Tenant Group 2', slug='tenant-group-2', parent=parent_tenant_groups[1], description='B'),
        TenantGroup.objects.create(name='Tenant Group 3', slug='tenant-group-3', parent=parent_tenant_groups[2], description='C'),
