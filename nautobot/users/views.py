...
from .models import AdminGroup, ObjectPermission, Token, User
...
class ObjectPermissionUIViewSet(
    ...
    queryset = ObjectPermission.objects.prefetch_related("object_types", "users", "groups").annotate(
    ...
    object_detail_content = object_detail.ObjectDetailContent(
        panels=[
            ...
            object_detail.ObjectsTablePanel(
                ...
                section=SectionChoices.RIGHT_HALF,
                table_class=UserTable,
                table_filter="object_permissions",
                table_title="Assigned Users",
