...
urlpatterns = [
    ...
    # Lookup Expr
    path("filterset-fields/lookup-choices/", GetFilterSetFieldLookupExpressionChoicesAPI.as_view(), name="lookup_choices"),
    path("filterset-fields/lookup-value-dom-element/", GetFilterSetFieldDOMElementAPI.as_view(), name="lookup_value_dom_element"),
]
