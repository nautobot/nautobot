...
from celery.beat import (  # type: ignore[import-untyped]  # missing in celery-types at present
...
from kombu.utils.json import loads  # type: ignore[import-untyped]  # missing in celery-types at present
