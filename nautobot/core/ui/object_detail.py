...
class _JobModalButton(Button):
    ...
    # DO we want to allow the job modal button full control over the html or do we want to build the button in core.
    @classmethod
    def get_redirect_button(cls, job_result, request, **kwargs):
        """Optinally render a button on the final page of the modal after the job has completed.
        Keyword Args:
            job_result (JobResult): The JobResult instance generated by the job modal.
        ...
        Returns:
            A string of HTML to render on the final page of the job modal.
        """
        return ""
