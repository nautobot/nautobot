...
class EChartsTypeTheme(ChoiceSet):
    ...
    COLORS = {
        LIGHT: [
            ...
            UI_COLORS["lightblue"]["light"],
            UI_COLORS["lightorange"]["light"],
            UI_COLORS["lightgreen"]["light"],
            UI_COLORS["lightred"]["light"],
            UI_COLORS["lightgray"]["light"],
        ],
        DARK: [
            UI_COLORS["blue"]["dark"],
            ...
            UI_COLORS["red"]["dark"],
            UI_COLORS["gray"]["dark"],
            UI_COLORS["lightblue"]["dark"],
            UI_COLORS["lightorange"]["dark"],
            UI_COLORS["lightgreen"]["dark"],
            UI_COLORS["lightred"]["dark"],
            UI_COLORS["lightgray"]["dark"],
        ],
    }
