...
class BaseTable(django_tables2.Table):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :warning base_column: Do not modify/set the `base_columns` attribute after BaseTable class is instantiated.
        :warning base_column: Do not modify/set the `base_columns` attribute after calling super().__init__() of BaseTable class.
        """
