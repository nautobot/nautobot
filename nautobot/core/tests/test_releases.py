...
class GetReleasesTestCase(SimpleTestCase):
    ...
    def test_pre_releases(self, example_cache_get: Mock, example_cache_set: Mock, example_request_get: Mock):
        example_cache_get.side_effect = CacheMiss()
        example_request_get.side_effect = successful_github_response
        ...
        example_request_get.assert_called_once_with(
        ...
        example_cache_set.assert_called_once_with("latest_release", (expected_version, expected_url), 160876)

    @patch.object(requests, "get")
    @patch.object(RedisCache, "set")
    @patch.object(RedisCache, "get")
    def test_no_pre_releases(self, example_cache_get: Mock, example_cache_set: Mock, example_request_get: Mock):
        example_cache_get.side_effect = CacheMiss()
        example_request_get.side_effect = successful_github_response
    ...
    @patch.object(RedisCache, "set")
    @patch.object(RedisCache, "get")
    def test_failed_request(self, example_cache_get: Mock, example_cache_set: Mock, example_request_get: Mock):
        example_cache_get.side_effect = CacheMiss()
        example_request_get.side_effect = unsuccessful_github_response
        ...
        example_cache_set.assert_called_once_with("latest_release_no_retry", "https://localhost/unittest/releases", 900)

    @patch.object(requests, "get")
    @patch.object(RedisCache, "set")
    @patch.object(RedisCache, "get")
    def test_blocked_retry(self, example_cache_get: Mock, example_cache_set: Mock, example_request_get: Mock):
        example_cache_get.return_value = "https://localhost/unittest/releases"
        example_request_get.side_effect = successful_github_response
        ...
        example_request_get.assert_not_called()

        # Check if cache is not updated
        example_cache_set.assert_not_called()
