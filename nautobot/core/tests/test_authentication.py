...
class ObjectPermissionAPIViewTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.prefixes = [
            Prefix.objects.create(prefix=IPNetwork("10.0.0.0/24"), location=cls.locations[0], status=statuses[0]),
            Prefix.objects.create(prefix=IPNetwork("10.0.1.0/24"), location=cls.locations[0], status=statuses[0]),
            Prefix.objects.create(prefix=IPNetwork("10.0.2.0/24"), location=cls.locations[0], status=statuses[0]),
            Prefix.objects.create(prefix=IPNetwork("10.0.3.0/24"), location=cls.locations[1], status=statuses[0]),
            Prefix.objects.create(prefix=IPNetwork("10.0.4.0/24"), location=cls.locations[1], status=statuses[0]),
            Prefix.objects.create(prefix=IPNetwork("10.0.5.0/24"), location=cls.locations[1], status=statuses[0]),
            Prefix.objects.create(prefix=IPNetwork("10.0.6.0/24"), location=cls.locations[2], status=statuses[0]),
            Prefix.objects.create(prefix=IPNetwork("10.0.7.0/24"), location=cls.locations[2], status=statuses[0]),
            Prefix.objects.create(prefix=IPNetwork("10.0.8.0/24"), location=cls.locations[2], status=statuses[0]),
        ]
