...
from nautobot.core.views import CustomGraphQLView, HomeView, StaticMediaFailureView, SearchView, CSRFRefreshView
...
urlpatterns = [
    ...
    path("csrfrefresh/", CSRFRefreshView.as_view(), name="csrfrefresh"),
