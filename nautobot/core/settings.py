...
# Modules to explicitly import on Celery worker startup. This is not intended to be user-serviceable
# as we are relying on this functionality for system jobs.
...
CELERY_TASK_WORKER_REDIRECT_STDOUTS = os.getenv("NAUTOBOT_CELERY_TASK_WORKER_REDIRECT_STDOUTS", True)
...
CELERY_TASK_WORKER_REDIRECT_STDOUTS_LEVEL = os.getenv("NAUTOBOT_CELERY_TASK_WORKER_REDIRECT_STDOUTS_LEVEL", "WARNING")
