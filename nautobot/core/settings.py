...
if "NAUTOBOT_RATE_LIMITING_WINDOW_SECONDS" in os.environ:
    NAUTOBOT_RATE_LIMITING_WINDOW_SECONDS = float(os.getenv("NAUTOBOT_RATE_LIMITING_WINDOW_SECONDS", "60.0"))
# TODO: Overloaded term with DRF, suggest name change
if "NAUTOBOT_RATE_LIMITING_RECORDS_LIMIT" in os.environ:
    NAUTOBOT_RATE_LIMITING_LIMIT = int(os.getenv("NAUTOBOT_RATE_LIMITING_RECORDS_LIMIT", "1000"))
if "NAUTOBOT_RATE_LIMITING_CALIBRATION_LOG" in os.environ:
    NAUTOBOT_RATE_LIMITING_CALIBRATION_LOG = is_truthy(os.getenv("NAUTOBOT_RATE_LIMITING_CALIBRATION_LOG", "False"))
if "NAUTOBOT_RATE_LIMITING_CALIBRATION_SAMPLE_RATE" in os.environ:
    NAUTOBOT_RATE_LIMITING_CALIBRATION_SAMPLE_RATE = float(
        os.getenv("NAUTOBOT_RATE_LIMITING_CALIBRATION_SAMPLE_RATE", "1.0")
    )

# REST Rate Limiting Complexity Cost Settings
if "NAUTOBOT_REST_RATE_LIMITING_MODE" in os.environ:
    NAUTOBOT_REST_RATE_LIMITING_MODE = str(os.getenv("NAUTOBOT_REST_RATE_LIMITING_MODE", "off"))
if "NAUTOBOT_REST_RATE_LIMITING_READ_COST" in os.environ:
    NAUTOBOT_REST_RATE_LIMITING_READ_COST = float(os.getenv("NAUTOBOT_REST_RATE_LIMITING_READ_COST", "1.0"))
if "NAUTOBOT_REST_RATE_LIMITING_WRITE_COST" in os.environ:
    NAUTOBOT_REST_RATE_LIMITING_WRITE_COST = float(os.getenv("NAUTOBOT_REST_RATE_LIMITING_WRITE_COST", "3.0"))
# TODO: Come back to this, not sure about the naming/calculation decision
if "NAUTOBOT_REST_RATE_LIMITING_RECORDS_PER_PAGE_DIVISOR" in os.environ:
    NAUTOBOT_REST_RATE_LIMITING_RECORDS_PER_PAGE_DIVISOR = float(
        os.getenv("NAUTOBOT_REST_RATE_LIMITING_RECORDS_PER_PAGE_DIVISOR", "50")
    )
if "NAUTOBOT_REST_RATE_LIMITING_PER_JOIN_COST" in os.environ:
    NAUTOBOT_REST_RATE_LIMITING_PER_JOIN_COST = float(os.getenv("NAUTOBOT_REST_RATE_LIMITING_PER_JOIN_COST", "1.0"))
if "NAUTOBOT_REST_RATE_LIMITING_UNINDEXABLE_LOOKUP_COST" in os.environ:
    NAUTOBOT_REST_RATE_LIMITING_UNINDEXABLE_LOOKUP_COST = float(
        os.getenv("NAUTOBOT_REST_RATE_LIMITING_UNINDEXABLE_LOOKUP_COST", "5.0")
    )
if "NAUTOBOT_REST_RATE_LIMITING_DEPTH_MULTIPLIER_PER_LEVEL" in os.environ:
...
if "NAUTOBOT_REST_RATE_LIMITING_COMPUTED_FIELDS_MULTIPLIER" in os.environ:
...
if "NAUTOBOT_REST_RATE_LIMITING_CSV_MULTIPILER" in os.environ:
    NAUTOBOT_REST_RATE_LIMITING_CSV_MULTIPLIER = float(os.getenv("NAUTOBOT_REST_RATE_LIMITING_CSV_MULTIPILER", "3.0"))

# GraphQL Rate Limiting Complexity Cost Settings
if "NAUTOBOT_GRAPHQL_RATE_LIMITING_MODE" in os.environ:
