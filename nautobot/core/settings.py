...
if "NAUTOBOT_REST_RATE_LIMITING_INDEXABLE_LOOKUP_COST" in os.environ:
...
if "NAUTOBOT_REST_RATE_LIMITING_CSV_MULTIPILIER" in os.environ:
    NAUTOBOT_REST_RATE_LIMITING_CSV_MULTIPLIER = float(os.getenv("NAUTOBOT_REST_RATE_LIMITING_CSV_MULTIPILIER", "3.0"))
