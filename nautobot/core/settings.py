...
METRICS_EXPERIMENTAL_CACHING_DURATION = int(os.getenv("NAUTOBOT_METRICS_EXPERIMENTAL_CACHING_DURATION", "300")) # TODO: set to 0 after testing
METRICS_EXPERIMENTAL_CACHING_ENABLED = METRICS_EXPERIMENTAL_CACHING_DURATION > 0
