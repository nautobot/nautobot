...
OTEL_PYTHON_EXCLUDED_URLS = os.getenv("OTEL_PYTHON_EXCLUDED_URLS", "health")
OTEL_PYTHON_INSTRUMENTATION_SANITIZE_REDIS = is_truthy(os.getenv("OTEL_PYTHON_INSTRUMENTATION_SANTIZE_REDIS", "True"))
