...
NAUTOBOT_RATE_LIMITING_CALIBRATION_SAMPLE_RATE = float(os.getenv("NAUTOBOT_RATE_LIMITING_CALIBRATION_SAMPLE_RATE", "1.0"))
...
NAUTOBOT_REST_RATE_LIMITING_CSV_MULTIPILIER = float(os.getenv("NAUTOBOT_REST_RATE_LIMITING_CSV_MULTIPILIER", "3.0"))
