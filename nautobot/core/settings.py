...
if "NAUTOBOT_RATE_LIMITING_CALIBRATION_SAMPLE_RATE" in os.environ:
    NAUTOBOT_RATE_LIMITING_SETTINGS["CALIBRATION_SAMPLE_RATE"] = float(
        os.getenv("NAUTOBOT_RATE_LIMITING_CALIBRATION_SAMPLE_RATE")
    )
...
if "NAUTOBOT_RATE_LIMITING_RECORDS_PER_PAGE_DIVISOR" in os.environ:
    NAUTOBOT_REST_RATE_LIMITING_DEFAULT_SETTINGS["records_per_page_divisor"] = float(
        os.getenv("NAUTOBOT_RATE_LIMITING_RECORDS_PER_PAGE_DIVISOR")
    )
if "NAUTOBOT_RATE_LIMITING_PER_JOIN_COST" in os.environ:
    NAUTOBOT_REST_RATE_LIMITING_DEFAULT_SETTINGS["per_join_cost"] = float(
        os.getenv("NAUTOBOT_RATE_LIMITING_PER_JOIN_COST")
    )
if "NAUTOBOT_RATE_LIMITING_UNINDEXABLE_LOOKUP_COST" in os.environ:
    NAUTOBOT_REST_RATE_LIMITING_DEFAULT_SETTINGS["unindexable_lookup_cost"] = float(
        os.getenv("NAUTOBOT_RATE_LIMITING_UNINDEXABLE_LOOKUP_COST")
    )
if "NAUTOBOT_RATE_LIMITING_DEPTH_MULTIPLIER_PER_LEVEL" in os.environ:
    NAUTOBOT_REST_RATE_LIMITING_DEFAULT_SETTINGS["depth_multiplier_per_level"] = float(
        os.getenv("NAUTOBOT_RATE_LIMITING_DEPTH_MULTIPLIER_PER_LEVEL")
    )
if "NAUTOBOT_RATE_LIMITING_COMPUTED_FIELDS_MULTIPLIER" in os.environ:
    NAUTOBOT_REST_RATE_LIMITING_DEFAULT_SETTINGS["computed_fields_multiplier"] = float(
        os.getenv("NAUTOBOT_RATE_LIMITING_COMPUTED_FIELDS_MULTIPLIER")
    )
if "NAUTOBOT_RATE_LIMITING_CSV_MULTIPILER" in os.environ:
    NAUTOBOT_REST_RATE_LIMITING_DEFAULT_SETTINGS["csv_multiplier"] = float(
        os.getenv("NAUTOBOT_RATE_LIMITING_CSV_MULTIPILER")
    )
