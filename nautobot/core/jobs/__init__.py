...
from nautobot.core.jobs.cleanup import ObjectChangeCleanup
...
jobs = [ExportObjectList, GitRepositorySync, GitRepositoryDryRun, ImportObjects, ObjectChangeCleanup]
register_jobs(*jobs)
