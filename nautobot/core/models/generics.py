...
from nautobot.extras.models.computed_fields import ComputedFieldModelMixin
...
class OrganizationalModel(BaseModel, ChangeLoggedModel, CustomFieldModel, RelationshipModel, ComputedFieldModelMixin):
    """
...
class PrimaryModel(BaseModel, ChangeLoggedModel, CustomFieldModel, RelationshipModel, ComputedFieldModelMixin):
    """
