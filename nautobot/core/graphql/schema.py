...
def extend_schema_type_fk(schema_type, model):
    ...
    object permissions. For each such field whose related model has a registered GraphQL type, we install a
    resolver that hides the related object when the requesting user is not permitted to view it.
