...
class L2VPNForm(NautobotModelForm):
    ...
    # Removed Slug - page loads showed js error, coz slug  is autogenerated
    # Removes the JavaScript error about missing data-source-fields
    # This fixed Status drop down issue.
    class Meta:
        model = models.L2VPN
        fields = [
            "name",
