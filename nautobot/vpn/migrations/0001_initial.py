# Generated by Django 4.2.20 on 2025-03-28 14:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "vpn_phase1_policy",
                    models.ManyToManyField(blank=True, related_name="vpn_profiles", to="vpn.vpnphase1policy"),
                ),
                (
                    "vpn_phase2_policy",
                    models.ManyToManyField(blank=True, related_name="vpn_profiles", to="vpn.vpnphase2policy"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "vpn",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="vpn_tunnels", to="vpn.vpn"
                    ),
                ),
                (
                    "vpn_profile",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, related_name="vpn_tunnels", to="vpn.vpnprofile"
                    ),
                ),
            ],
            options={
