...
class="badge label-{% if entry.content_identifier in record.provided_contents %}success{% else %}default{% endif %}">
...
class JobLogEntryTable(BaseTable):
    ...
    def render_log_level(self, value):
        ...
        return format_html('<label class="badge label-{}">{}</label>', log_level, value)
...
class JobResultTable(BaseTable):
    ...
    actions = tables.TemplateColumn(
        template_code="""
            ...
            {% if perms.extras.run_job %}
                ...
                {% else %}
                    <a href="#" class="btn btn-sm btn-secondary disabled" title="Job is not available, cannot be re-run">
    ...
    def render_summary(self, record):
        ...
        return format_html(
            ...
            <label class="badge label-warning">{}</label>
