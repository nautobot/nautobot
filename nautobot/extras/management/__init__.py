...
STATUS_CHOICESET_MAP = {
    ...
    "extras.ApprovalWorkflowInstance": extras_choices.ApprovalWorkflowStateChoices,
    "extras.ApprovalWorkflowStageInstance": extras_choices.ApprovalWorkflowStateChoices,
    "extras.ApprovalWorkflowStageInstanceResponse": extras_choices.ApprovalWorkflowStateChoices,
