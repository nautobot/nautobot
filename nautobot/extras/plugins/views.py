...
def get_app_description(package_name, app_configs, marketplace_data):
                ...
                data.append(
                    {
                        ...
                        "description": get_app_description(app.name, app_configs, marketplace_data),
                        "version": app.version,
                        "actions": {
                            "home": home_url,
...
class InstalledAppDetailView(GenericView):
    ...
    def get(self, request, app=None, plugin=None):
        ...
        return render(
            ...
            {
                "object": app_config,
                "description": get_app_description(app_config.name, [app_config], load_marketplace_data()),
            },
        )
...
class InstalledAppsAPIView(NautobotAPIVersionMixin, APIView):
    ...
    def _get_app_data(app_config, marketplace_data):
        ...
        return {
            ...
            "description": get_app_description(app_config.name, [app_config], marketplace_data),
