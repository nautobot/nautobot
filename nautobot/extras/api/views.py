...
from nautobot.utilities.utils import copy_safe_request, count_related, versioned_serializer_selector
...
class TagViewSet(CustomFieldModelViewSet):
    ...
    def get_serializer_class(self):
        return versioned_serializer_selector(
            obj=self, legacy_serializer=serializers.TagSerializer, serializer=super().get_serializer_class()
        )
