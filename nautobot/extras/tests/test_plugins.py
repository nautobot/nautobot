...
from nautobot.extras.models import CustomField, Secret, RelationshipAssociation, Relationship, Status
...
class PluginTest(TestCase):
    ...
    def test_custom_validators_registration(self):
        ...
        """
        from dummy_plugin.custom_validators import SiteCustomValidator, RelationshipAssociationCustomValidator
