...
urlpatterns = [
    ...
    path("secret-types/", views.SecretTypeListView.as_view(), name="secrettype_list"),
    path("secret-types/add/", views.SecretTypeEditView.as_view(), name="secrettype_add"),
    path("secret-types/delete/", views.SecretTypeBulkDeleteView.as_view(), name="secrettype_bulk_delete"),
    path("secret-types/import/", views.SecretTypeBulkImportView.as_view(), name="secrettype_import"),
    path("secret-types/<str:slug>/", views.SecretTypeView.as_view(), name="secrettype"),
    path("secret-types/<str:slug>/edit/", views.SecretTypeEditView.as_view(), name="secrettype_edit"),
    path("secret-types/<str:slug>/delete/", views.SecretTypeDeleteView.as_view(), name="secrettype_delete"),
    path(
        "secret-types/<str:slug>/changelog/",
        views.ObjectChangeLogView.as_view(),
        name="secrettype_changelog",
        kwargs={"model": SecretType},
    ),
    # Custom statuses
