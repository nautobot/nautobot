...
urlpatterns = [
    ...
    path("custom-fields/<slug:key>/", views.CustomFieldView.as_view(), name="customfield"),
    path(
        "custom-fields/<slug:key>/edit/",
        views.CustomFieldEditView.as_view(),
        name="customfield_edit",
    ),
    path(
        "custom-fields/<slug:key>/delete/",
        views.CustomFieldDeleteView.as_view(),
        name="customfield_delete",
    ),
    path(
        "custom-fields/<slug:key>/changelog/",
        views.ObjectChangeLogView.as_view(),
        name="customfield_changelog",
        kwargs={"model": CustomField},
    ),
    path(
        "custom-fields/<slug:key>/notes/",
        views.ObjectNotesView.as_view(),
