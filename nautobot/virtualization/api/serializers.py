...
from nautobot.core.api import ChoiceField, SerializedPKRelatedField, ValidatedModelSerializer
from nautobot.dcim.api.nested_serializers import NestedDeviceRoleSerializer, NestedPlatformSerializer, NestedSiteSerializer
