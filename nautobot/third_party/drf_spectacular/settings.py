...
SPECTACULAR_DEFAULTS: Dict[str, Any] = {
    ...
    'DEFAULT_GENERATOR_CLASS': 'nautobot.third_party.drf_spectacular.generators.SchemaGenerator',
    ...
    'POSTPROCESSING_HOOKS': [
        'nautobot.third_party.drf_spectacular.hooks.postprocess_schema_enums'
    ],
    ...
    'GET_LIB_DOC_EXCLUDES': 'nautobot.third_party.drf_spectacular.plumbing.get_lib_doc_excludes',
    ...
    'GET_MOCK_REQUEST': 'nautobot.third_party.drf_spectacular.plumbing.build_mock_request',
