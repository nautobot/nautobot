...
from nautobot.third_party.drf_spectacular.renderers import (
    OpenApiJsonRenderer, OpenApiJsonRenderer2, OpenApiYamlRenderer, OpenApiYamlRenderer2,
)
from nautobot.third_party.drf_spectacular.settings import patched_settings, spectacular_settings
from nautobot.third_party.drf_spectacular.types import OpenApiTypes
from nautobot.third_party.drf_spectacular.utils import OpenApiParameter, extend_schema
...
class SpectacularSwaggerView(APIView):
    ...
    def _get_schema_auth_names(self):
        from nautobot.third_party.drf_spectacular.extensions import OpenApiAuthenticationExtension
