...
from nautobot.third_party.drf_spectacular.drainage import Literal, _TypedDictMeta, cache, error, warn
from nautobot.third_party.drf_spectacular.settings import spectacular_settings
from nautobot.third_party.drf_spectacular.types import (
...
def is_serializer(obj) -> bool:
    from nautobot.third_party.drf_spectacular.serializers import OpenApiSerializerExtension
    return (
