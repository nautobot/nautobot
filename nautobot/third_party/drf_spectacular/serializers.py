from nautobot.third_party.drf_spectacular.drainage import error, warn
from nautobot.third_party.drf_spectacular.extensions import OpenApiSerializerExtension
from nautobot.third_party.drf_spectacular.plumbing import force_instance, is_list_serializer, is_serializer


class PolymorphicProxySerializerExtension(OpenApiSerializerExtension):
    target_class = 'nautobot.third_party.drf_spectacular.utils.PolymorphicProxySerializer'
    priority = -1
