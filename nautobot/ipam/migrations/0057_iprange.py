    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["ip_version", "start_host", "end_host"], name="ipam_iprang_ip_vers_a40084_idx"
                    ),
                    models.Index(fields=["start_host", "end_host"], name="ipam_iprang_start_h_799328_idx"),
                ],
                "constraints": [
                    models.UniqueConstraint(
                        fields=("parent", "start_host", "end_host"), name="unique_iprange_parent_start_end"
                    )
                ],
            },
            bases=(
