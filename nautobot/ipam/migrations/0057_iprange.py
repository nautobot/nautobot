    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_host', nautobot.ipam.fields.VarbinaryIPField(db_index=True, editable=True)),
                ('end_host', nautobot.ipam.fields.VarbinaryIPField(db_index=True, editable=True)),
                ...
                ('parent', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.PROTECT, related_name='ip_ranges', to='ipam.prefix')),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['ip_version', 'start_host', 'end_host'], name='ipam_iprang_ip_vers_a40084_idx'), models.Index(fields=['start_host', 'end_host'], name='ipam_iprang_start_h_799328_idx')],
                'constraints': [models.UniqueConstraint(fields=('parent', 'start_host', 'end_host'), name='unique_iprange_parent_start_end')],
            },
