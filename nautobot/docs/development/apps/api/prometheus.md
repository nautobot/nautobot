...
It is possible for Nautobot apps to provide their own [Prometheus metrics](../../../user-guide/administration/monitoring/prometheus-metrics.md). There are two general ways to achieve this:
