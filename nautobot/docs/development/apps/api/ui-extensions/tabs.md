...
When creating your own tab view, these must register the object detail views. This is documented in [Object Detail Views](object-detail-veiws.md) within the template extension. Each tab should have a unique item in the list returned of the detail_tabs method.
