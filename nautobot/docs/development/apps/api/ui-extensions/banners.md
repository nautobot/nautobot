...
!!! tip
    A `Banner` returned from the `banner()` function is displayed continuously. To inform or prompt a user once, queue a [user facing message](user-facing-messages.md) instead.
