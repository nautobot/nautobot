...
| Docker Compose Workflow | Virtual Environment Workflow                                                                            |
| ----------------------- | --------------------------------------------------------------------------------------------------------------- |
| `invoke ruff`           | `ruff check nautobot/ development/ examples/ tasks.py && ruff format nautobot/ development/ examples/ tasks.py` |
...
You’ll also want to run `invoke ruff --autoformat` against the generated migration file as the autogenerated code doesn’t follow our style guide by default.
