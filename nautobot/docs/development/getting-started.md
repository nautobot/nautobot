...
If your branch modifies a Django model (and as a result requires a database schema modification), after running `invoke makemigrations` rename the generated migration files to something more meaningful before pushing. For example `0004_provider_increase_account_length` instead of `0004_auto_20211220_2104`.
