...
- `invoke debug` - Starts Linux system, PostgreSQL, Redis, and Nautobot in debug mode and attaches their output to the terminal in the foreground. You may enter Control-C to stop the containers.
