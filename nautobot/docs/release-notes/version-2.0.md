...
Check out the [Region and Site Related Data Model Migration Guide](../plugins/region-and-site-data-migration-guide.md#region-and-site-related-data-model-migration-guide) to learn how to migrate your Nautobot Apps and data models from `Site` and `Region` to `Location`.
