...
You can refer to the [plugin development guide](../development/apps/api/ui-extensions/object-detail-views.md#adding-detail-tabs) on how to add tabs to existing object detail views.
