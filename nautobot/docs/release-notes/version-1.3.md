...
The online REST API documentation (`/api/docs/`) has been updated from Swagger (OpenAPI 2.0) format to OpenAPI 3.0 format and now supports Nautobot's [REST API versioning](#rest-api-versioning-1465) as described above. Try `/api/docs/?api_version=1.3` as an example.
...
- [#595](https://github.com/nautobot/nautobot/issues/595) - Migrated from `drf-yasg` (Swagger / OpenAPI 2.0) to `drf-spectacular` (OpenAPI 3.0) for REST API interactive documentation.
