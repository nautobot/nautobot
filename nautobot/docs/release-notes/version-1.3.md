...
- [#898](https://github.com/nautobot/nautobot/issues/898) - Added support for hiding a CustomField, Relationship or ComputedField from the main tab of an object's detail page in the UI.
