...
#### Dropped Support for Legacy PostgreSQL versions

Nautobot 3.0 drops support for PostgreSQL versions 12.x and 13.x, and now requires a minimum of version 14.0.
