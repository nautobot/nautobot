...
Each cable may be assigned a type, label, length, and color. Each cable must also assigned to an operational [`status`](../../../models/extras/status/). The following statuses are available by default:
