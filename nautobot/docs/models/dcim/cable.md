...
Each cable may be assigned a type, label, length, and color. Each cable must also assigned to an operational [`status`](../extras/status.md). The following statuses are available by default:
