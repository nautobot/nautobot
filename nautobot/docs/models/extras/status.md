...
Another example for locations is tracking the nature of a specific location's installation status. A location that is under construction could received a status like 'Pre Production'.
