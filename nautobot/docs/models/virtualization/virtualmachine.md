...
Like devices, each VM can be assigned a platform and/or functional role, and an operational [`status`](../../../models/extras/status/). The following statuses are available by default:
