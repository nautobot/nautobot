...
Each namespace has a name and a description, and can optionally be associated to a [location](../dcim/location.md) and/or [tenant](../tenancy/tenant.md) for informational purposes.

+++ 3.0.0 "Added tenant association as an option"
