...
Each site must be assigned a unique name and operational [`status`](../../platform-functionality/status.md) and may optionally be assigned to a region and/or tenant. The following operational statuses are available by default:
