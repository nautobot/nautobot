...
The primary piece of information to consider from this list is the Management Control Plane Count. When it is **one** you should use a [Virtual Chassis](./virtualchassis.md) and when it is **two**, you should use a [Device Redundancy Group](./deviceredundancygroup.md).
