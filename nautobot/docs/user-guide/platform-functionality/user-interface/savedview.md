...
Note that there is a "Saved Views" icon on the right hand side.
...
In this example, we will name this new Saved View "Branch Active Location List View" and make this view public (shared with other users).
...
![Successfully Created New Saved View](../../feature-guides/images/saved-views/create-saved-view-success_light.png#only-light){ .on-glb }
![Successfully Created New Saved View](../../feature-guides/images/saved-views/create-saved-view-success_dark.png#only-dark){ .on-glb }

Click the "Saved Views" icon again and you should see your new Saved View's name and a new option "Update Current View" can be seen.

![Creating New Saved View](../../feature-guides/images/saved-views/dropdown-button-after-new-saved-view_light.png#only-light){ .on-glb }
![Creating New Saved View](../../feature-guides/images/saved-views/dropdown-button-after-new-saved-view_dark.png#only-dark){ .on-glb }
...
![Unsaved Saved View Add Filter](../../feature-guides/images/saved-views/unsaved-saved-view-1_light.png#only-light){ .on-glb }
![Unsaved Saved View Add Filter](../../feature-guides/images/saved-views/unsaved-saved-view-1_dark.png#only-dark){ .on-glb }

![Unsaved Saved View](../../feature-guides/images/saved-views/unsaved-saved-view-2_light.png#only-light){ .on-glb }
![Unsaved Saved View](../../feature-guides/images/saved-views/unsaved-saved-view-2_dark.png#only-dark){ .on-glb }

Click the "Saved Views" icon and you should now see the option "Update Current Saved View".

Click "Update Current Saved View" option and the page should refresh and you should see the success banner on top of the page stating "Successfully updated current view Branch Active Location List View".

Congratulations, you have successfully updated your Saved View!

![Updated Saved View](../../feature-guides/images/saved-views/updated-saved-view_light.png#only-light){ .on-glb }
![Updated Saved View](../../feature-guides/images/saved-views/updated-saved-view_dark.png#only-dark){ .on-glb }

### How to navigate Saved Views

There are several ways you can navigate Saved Views. As we've already seen, any given model list view has a "Saved Views" icon, which opens a drawer showing all Saved Views that you have access to for this view (those that you have created, and those that other users have created and shared). The Saved View that you're currently using will be highlighted.
...
![Saved View Table Edit Button](../../feature-guides/images/saved-views/saved-view-admin-edit-buttons_light.png#only-light){ .on-glb }
![Saved View Table Edit Button](../../feature-guides/images/saved-views/saved-view-admin-edit-buttons_dark.png#only-dark){ .on-glb }
...
![Saved View Edit View](../../feature-guides/images/saved-views/saved-view-admin-edit-view_light.png#only-light){ .on-glb }
![Saved View Edit View](../../feature-guides/images/saved-views/saved-view-admin-edit-view_dark.png#only-dark){ .on-glb }
...
![Saved View Edit Success](../../feature-guides/images/saved-views/saved-view-admin-edit-success_light.png#only-light){ .on-glb }
![Saved View Edit Success](../../feature-guides/images/saved-views/saved-view-admin-edit-success_dark.png#only-dark){ .on-glb }
...
![Saved View Modal Unchecked](../../feature-guides/images/saved-views/saved-view-modal-unchecked_light.png#only-light){ .on-glb }
![Saved View Modal Unchecked](../../feature-guides/images/saved-views/saved-view-modal-unchecked_dark.png#only-dark){ .on-glb }
...
![Saved View Edit View Unchecked](../../feature-guides/images/saved-views/saved-view-admin-edit-view-unchecked_light.png#only-light){ .on-glb }
![Saved View Edit View Unchecked](../../feature-guides/images/saved-views/saved-view-admin-edit-view-unchecked_dark.png#only-dark){ .on-glb }
...
You can also set a Saved View as default for an object list view for yourself, overriding the global default. You can set a view as default by navigate to the view from the Saved View icon, for example, "Private Location List View". Clicking on the Saved Views icon again, you should be able to see the option named "Set As My Default".

![Set As My Default Button](../../feature-guides/images/saved-views/set-as-my-default-button_light.png#only-light){ .on-glb }
![Set As My Default Button](../../feature-guides/images/saved-views/set-as-my-default-button_dark.png#only-dark){ .on-glb }
...
![Set As My Default Success](../../feature-guides/images/saved-views/set-as-my-default-success_light.png#only-light){ .on-glb }
![Set As My Default Success](../../feature-guides/images/saved-views/set-as-my-default-success_dark.png#only-dark){ .on-glb }

### How to clear configurations on a Saved View

Clicking the "No saved view" will direct you back to the default object list view with no Saved View applied.

![Clear View Button](../../feature-guides/images/saved-views/clear-view-button_light.png#only-light){ .on-glb }
![Clear View Button](../../feature-guides/images/saved-views/clear-view-button_dark.png#only-dark){ .on-glb }
