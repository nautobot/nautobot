...
In the event you need to create a customized Django Redis client, the folloiwng settings can be changed:

* [`CLIENT_CLASS`](https://github.com/jazzband/django-redis?tab=readme-ov-file#pluggable-clients)
* [`CUSTOM_HEALTH_CHECK_CLASS`](../configuration/settings.md#custom_health_check_class)
