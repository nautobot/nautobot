...
+++ 2.2.1
    In case the `/metrics` endpoint is unacceptably slow to respond, you can disable specific apps that may be causing problems with the `METRICS_DISABLED_APPS` configuration setting.
