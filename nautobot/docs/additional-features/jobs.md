...
This can accept either plain text, Markdown-formatted text, or a limited subset of HTML. It can also be multiple lines:
...
Markdown rendering is supported for log messages, as are a limited subset of HTML tags.
