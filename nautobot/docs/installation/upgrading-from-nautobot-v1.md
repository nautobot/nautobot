...
!!! important
    If you are a Nautobot App developer, please review the [Region and Site Related Data Model Migration Guide](../plugins/region-and-site-data-migration-guide.md#region-and-site-related-data-model-migration-guide) to learn how to migrate your apps and models from `Site` and `Region` to `Location`.
