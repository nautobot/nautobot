...
_Changed in version 1.4.0: If [STRICT_FILTERING](../configuration/optional-settings.md#strict_filtering) is True, unrecognized filter parameters now result in a 400 Bad Request response instead of being silently ignored._
