...
urlpatterns = [
    ...
    path("models/edit/", views.DummyModelBulkEditView.as_view(), name="dummymodel_bulk_edit"),
    path(
        "models/delete/",
        views.DummyModelBulkDeleteView.as_view(),
        name="dummymodel_bulk_delete",
    ),
    path("models/import/", views.DummyModelBulkImportView.as_view(), name="dummymodel_import"),
    path("models/<uuid:pk>/", views.DummyModelView.as_view(), name="dummymodel"),
    path("models/<uuid:pk>/edit/", views.DummyModelEditView.as_view(), name="dummymodel_edit"),
    path(
