...
urlpatterns = [
    ...
    path("custom-device-tab-1/<uuid:pk>/", views.ExampleCustomTab1View.as_view(), name="example_object_tab_1"),
    path("custom-device-tab-2/<uuid:pk>/", views.ExampleCustomTab2View.as_view(), name="example_object_tab_2"),
]
