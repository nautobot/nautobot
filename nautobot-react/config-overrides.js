...
module.exports = function override(config, env) {
	...
	plugins = [
		new ModuleFederationPlugin({
			...
			filename: 'static/reactjs/core/nautobotRemoteEntry.js',
			exposes: {
	...
	const miniCssOptions = {
		filename: 'static/reactcss/core/[name].[contenthash:8].css',
		chunkFilename: 'static/reactcss/core/[name].[contenthash:8].chunk.css',
	}
	if (isEnvProduction) {
	...
	config.output.filename = isEnvProduction ? 'static/reactjs/core/[name].[contenthash:8].js' : isEnvDevelopment && 'static/reactjs/core/bundle.js';
	config.output.chunkFilename = isEnvProduction ? 'static/reactjs/core/[name].[contenthash:8].chunk.js' : isEnvDevelopment && 'static/reactjs/core/[name].chunk.js';
