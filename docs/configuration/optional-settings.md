...
Default: `$INSTALL_ROOT/nautobot_root/jobs/`
...
Default: $INSTALL_ROOT/nautobot_root/media/

The file path to the location where media files (such as image attachments) are stored. By default, this is the `nautobot_root/media/` directory within the base Nautobot installation path.
