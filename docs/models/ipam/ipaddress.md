...
Each IP address can also be assigned an operational status and a functional role. Default status options are provided, including the following, but may be customized as with any other "status" field in Nautobot:
