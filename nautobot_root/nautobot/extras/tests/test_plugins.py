...
from nautobot.extras.plugins.exceptions import PluginNotFound, PluginImproperlyConfigured
...
class PluginTest(TestCase):
    ...
    def test_config(self):
        ...
        self.assertIn('nautobot.extras.tests.dummy_plugin.DummyPluginConfig', settings.INSTALLED_APPS)
    ...
    def test_custom_validators_registration(self):
        ...
        """
        from nautobot.extras.tests.dummy_plugin.custom_validators import SiteCustomValidator
    ...
    def test_jobs_registration(self):
        ...
        self.assertEqual(DummyJob, get_job("plugins/nautobot.extras.tests.dummy_plugin.jobs/DummyJob"))
        self.assertIn("plugins/nautobot.extras.tests.dummy_plugin.jobs/DummyJob", get_job_classpaths())
        jobs_dict = get_jobs()
        self.assertIn("plugins", jobs_dict)
        self.assertIn("nautobot.extras.tests.dummy_plugin.jobs", jobs_dict["plugins"])
        self.assertEqual("DummyPlugin jobs", jobs_dict["plugins"]["nautobot.extras.tests.dummy_plugin.jobs"].get("name"))
        self.assertIn("jobs", jobs_dict["plugins"]["nautobot.extras.tests.dummy_plugin.jobs"])
        self.assertIn("DummyJob", jobs_dict["plugins"]["nautobot.extras.tests.dummy_plugin.jobs"]["jobs"])
        self.assertEqual(DummyJob, jobs_dict["plugins"]["nautobot.extras.tests.dummy_plugin.jobs"]["jobs"]["DummyJob"])
    ...
    def test_middleware(self):
        ...
        """
        self.assertIn('nautobot.extras.tests.dummy_plugin.middleware.DummyMiddleware', settings.MIDDLEWARE)
