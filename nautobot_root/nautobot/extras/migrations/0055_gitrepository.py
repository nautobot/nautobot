...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='owner_content_type',
            field=models.ForeignKey(blank=True, default=None, limit_choices_to=nautobot.extras.utils.FeatureQuery('export_template_owners'), null=True, on_delete=django.db.models.deletion.CASCADE, related_name='export_template_owners', to='contenttypes.contenttype'),
        ),
        migrations.AddField(
            model_name='exporttemplate',
            name='owner_object_id',
