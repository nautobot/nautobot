...
def populate_virtualmachine_status_db(apps, schema_editor):
    ...
    for virtualmachine in VirtualMachine.objects.all():
        virtualmachine.status_db = custom_statuses.get(slug=virtualmachine.status)
        virtualmachine.save()
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='status_db',
            field=nautobot.extras.models.statuses.StatusField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='virtualization_virtualmachine_related', to='extras.status'),
        ),
