...
GIT_ROOT = os.environ.get('NAUTOBOT_GIT_ROOT', os.path.join(BASE_DIR, 'git').rstrip('/'))
HTTP_PROXIES = None
JOBS_ROOT = os.environ.get('NAUTOBOT_JOBS_ROOT', os.path.join(BASE_DIR, 'jobs').rstrip('/'))
...
# Reports
REPORTS_ROOT = os.environ.get('NAUTOBOT_REPORTS_ROOT', os.path.join(BASE_DIR, 'reports').rstrip('/'))

# RQ
RQ_DEFAULT_TIMEOUT = 300

# Scripts
SCRIPTS_ROOT = os.environ.get('NAUTOBOT_SCRIPTS_ROOT', os.path.join(BASE_DIR, 'scripts').rstrip('/'))
