...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='address',
            field=nautobot.ipam.fields.IPAddressField(help_text='IPv4 or IPv6 address (with mask)'),
        ),
        migrations.AlterField(
            model_name='ipaddress',
            name='family',
        ...
        migrations.AlterField(
            model_name='prefix',
            name='prefix',
            field=nautobot.ipam.fields.IPNetworkField(help_text='IPv4 or IPv6 network with mask'),
        ),
        migrations.AlterField(
            model_name='prefix',
            name='role',
