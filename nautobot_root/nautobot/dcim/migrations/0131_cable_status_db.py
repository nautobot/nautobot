...
def populate_cable_status_db(apps, schema_editor):
    ...
    for cable in Cable.objects.all():
        cable.status_db = custom_statuses.get(slug=cable.status)
        cable.save()
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='cable',
            name='status_db',
            field=nautobot.extras.models.statuses.StatusField(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='dcim_cable_related', to='extras.status'),
        ),
