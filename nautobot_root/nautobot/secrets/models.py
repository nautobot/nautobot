...
from nautobot.extras.models import ChangeLoggedModel, CustomFieldModel, TaggedItem
...
class Secret(ChangeLoggedModel, CustomFieldModel):
    ...
    one Nautobot object, and objects may have multiple Secrets associated with them. A name can optionally be defined
